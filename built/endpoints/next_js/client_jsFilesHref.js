...
var client_jsFilesHref = function (directory) { return __awaiter(void 0, void 0, void 0, function () {
    var discoveredPaths, files, _i, files_1, file, code, ast;
    return __generator(this, function (_a) {
        console.log(chalk_1.default.cyan("[i] Searching for `href` in the JS chunks"));
        discoveredPaths = [];
                ...
                traverse(ast, {
                    ObjectProperty: function (path) {
                        ...
                        if (valueNode.type === "StringLiteral") {
                            ...
                            var pathArg = valueNode.arguments.find(function (arg) {
                            ...
                            if (pathArg) {
                                ...
                                var logicalExprArg = valueNode.arguments.find(function (arg) {
                                    return arg.type === "LogicalExpression" &&
                                        arg.operator === "||";
                                });
                                if (logicalExprArg &&
                        ...
                        if (hrefValue) {
                            var isPath = hrefValue.startsWith("/") ||
...
exports.default = client_jsFilesHref;
