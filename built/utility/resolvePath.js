 ...
 */
var resolvePath = function (url, path) {
    try {
        ...
        // - url='https://site.com/something/other', path='../main.js' => 'https://site.com/main.js'
        //   (Base for resolution becomes 'https://site.com/something/', then '../' navigates up)
        var resolvedUrl = new URL(path, url);
        return resolvedUrl.href;
    }
    catch (e) {
        console.error("Error resolving path \"".concat(path, "\" with base URL \"").concat(url, "\": ").concat(e.message));
