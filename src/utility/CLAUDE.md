...
- `openapiGenerator.ts` — assembles `mapped-openapi.json` from resolved endpoint records. Single source of truth for the OpenAPI shape.
- `postmanGenerator.ts` — Postman collection v2 export.
